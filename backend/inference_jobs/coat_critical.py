# backend/inference_jobs/coat_critical.py
import os
from typing import Dict, Any
from backend.modal_request import classify_critical_coat_to_csv
...
CSV_NAME = os.getenv("CRITICAL_COAT_CSV_NAME", "critical_coat_results.csv").strip()

def run_inference() -> Dict[str, Any]:
    return classify_critical_coat_to_csv(
