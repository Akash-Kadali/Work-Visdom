# backend/inference_jobs/coat_laser.py
import os
from typing import Dict, Any
from backend.modal_request import classify_laser_coat_to_csv
...
CSV_NAME = os.getenv("LASER_COAT_CSV_NAME", "laser_coat_results.csv").strip()

def run_inference() -> Dict[str, Any]:
    return classify_laser_coat_to_csv(
